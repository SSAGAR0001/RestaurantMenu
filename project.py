...
def showMenu(restaurant_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        ...
        'menu.html', restaurant=restaurant, items=items, restaurant_id=restaurant_id, creator=creator, s=login_session)
    return render_template(
        'mymenu.html', restaurant=restaurant, items=items, restaurant_id=restaurant_id, creator=creator)
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant != []:
        ...
        if request.method == 'POST':
            ...
            return render_template(
            'editedrestaurant.html', restaurant_id=restaurant_id, item=editedRestaurant)
...
def deleteRestaurant(restaurant_id):
    ...
    menus = session.query(MenuItem).filter_by(restaurant=itemToDelete).all()
    if itemToDelete != []:
        if 'username' not in login_session:
            return redirect('/login')
